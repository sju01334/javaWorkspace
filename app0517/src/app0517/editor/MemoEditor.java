...
public class MemoEditor extends JFrame{
	...
	JMenuItem item_saveas;//다른이름으로 저장
	...
	public MemoEditor() {
		...
		chooser=new JFileChooser("C:\\koreaIT\\javaworkspace\\app0514\\src");
		...
		item_open.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				//파일열기 아이템을 누르면, JTextArea에 "안녕"이라는 문자열을 출력
//				area.append("안녕");
				openFile();
			}
		});
		...
		setSize(700, 600);
		setVisible(true);
		setDefaultCloseOperation(EXIT_ON_CLOSE);//무언가 창을 닫을떄, 자원을 반납하려면
